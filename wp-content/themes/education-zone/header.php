...
<body <?php body_class(); ?>>
  ...
  <script>
  motionAI_Init('39322?color=62a8ea&sendBtn=SEND&inputBox=Type+something...&token=85fcb36e182f4b5a4d1e1f615281bc8b',true,400,470,'https://carryon.online/wp-content/uploads/2017/03/chat_img-1.png'); /* botID with access token, display bot icon?, modal width, modal height, call to action image */
